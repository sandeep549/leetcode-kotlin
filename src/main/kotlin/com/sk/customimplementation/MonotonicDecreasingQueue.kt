...
) : com.sk.customimplementation.MonotonicQueue<E> {
...
fun main() {
    com.sk.customimplementation.`test monotonic decresing queue`()
    com.sk.customimplementation.`test monotonic increasing queue`()
}

fun `test monotonic decresing queue`() {
    val queue: com.sk.customimplementation.MonotonicQueue<Int> =
        com.sk.customimplementation.MonotonicDecreasingQueue { o1, o2 ->
            if (o1 <= o2) -1 else 1
        }
